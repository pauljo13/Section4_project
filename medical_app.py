...
medical = pd.read_csv('/Users/bumsoojoe/Desktop/Section4_project/csv/medical.csv')
...
x_train = train.drop(columns=['charges','region'],axis=1)

y_val = val['charges']
x_val = val.drop(columns=['charges','region'],axis=1)

y_test = test['charges']
x_test = test.drop(columns=['charges','region'],axis=1)
